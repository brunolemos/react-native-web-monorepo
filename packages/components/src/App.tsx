        ...
        <ScrollView
          ...
          <View style={styles.body}>
            <View style={styles.sectionContainer}>
              <Text style={styles.sectionTitle}>This component is being shared between iOS, Android and Web</Text>
              <Text style={styles.sectionDescription}>
                Edit <Text style={styles.highlight}>packages/components/App.tsx</Text> to change this
                screen and then come back to see your edits (in your phone or browser).
              </Text>
            </View>
            <View style={styles.sectionContainer}>
